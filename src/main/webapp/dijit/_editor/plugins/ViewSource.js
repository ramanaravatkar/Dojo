...
return _26;
},_stripEventHandlers:function(_27){
if(_27){
var _28=_27.match(/<[a-z]+?\b(.*?on.*?(['"]).*?\2.*?)+>/gim);
if(_28){
for(var i=0,l=_28.length;i<l;i++){
var _29=_28[i];
var _2a=_29.replace(/\s+on[a-z]*\s*=\s*(['"])(.*?)\1/igm,"");
_27=_27.replace(_29,_2a);
}
}
}
return _27;
},_filter:function(_2b){
if(_2b){
if(this.stripScripts){
_2b=this._stripScripts(_2b);
}
if(this.stripComments){
_2b=this._stripComments(_2b);
}
if(this.stripIFrames){
_2b=this._stripIFrames(_2b);
}
if(this.stripEventHandlers){
_2b=this._stripEventHandlers(_2b);
}
}
return _2b;
},setSourceAreaCaret:function(){
var _2c=this.sourceArea;
_d.focus(_2c);
if(this._sourceShown&&!this.readOnly){
if(_2c.setSelectionRange){
_2c.setSelectionRange(0,0);
}else{
if(this.sourceArea.createTextRange){
var _2d=_2c.createTextRange();
_2d.collapse(true);
_2d.moveStart("character",-99999);
_2d.moveStart("character",0);
_2d.moveEnd("character",0);
_2d.select();
}
}
}
...
_e.registry["viewSource"]=_e.registry["viewsource"]=function(_2e){
return new _12({readOnly:("readOnly" in _2e)?_2e.readOnly:false,stripComments:("stripComments" in _2e)?_2e.stripComments:true,stripScripts:("stripScripts" in _2e)?_2e.stripScripts:true,stripIFrames:("stripIFrames" in _2e)?_2e.stripIFrames:true,stripEventHandlers:("stripEventHandlers" in _2e)?_2e.stripEventHandlers:true});
};
return _12;
});
